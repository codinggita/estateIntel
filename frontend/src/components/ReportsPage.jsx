...
const ReportsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100 pb-32">
      ...
      <div className="pt-32 pb-12 px-6 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <form onSubmit={handleSearchSubmit} className="relative max-w-2xl mx-auto">
             <div className="flex items-center bg-white border-2 border-slate-200 rounded-lg shadow-sm focus-within:border-indigo-600 transition-all">
                ...
                <input 
                  ...
                  className="flex-grow py-5 px-5 text-xl font-bold text-slate-900 outline-none placeholder:text-slate-300 bg-transparent"
                />
                <button type="submit" disabled={loading} className="bg-slate-900 text-white px-10 py-5 rounded-r-md font-bold uppercase tracking-widest text-xs hover:bg-slate-800 transition-all flex items-center gap-3">
        ...
        {report && !loading && (
          <div className="animate-in fade-in slide-in-from-bottom-6 duration-700 max-w-5xl mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm mb-32 overflow-hidden selection:bg-indigo-50">
               ...
               <div className="p-16 md:p-20 border-b border-slate-100 flex flex-col justify-between min-h-[500px]">
                  <div>
                    ...
                    <h2 className="text-3xl font-bold text-[#0F172A] tracking-tight mb-16 uppercase">Section 01 — Strategic Summary</h2>
                  ...
                  <div className="flex gap-16 mt-20 pt-12 border-t border-slate-100">
                    <div>
                      <div className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2">Primary Subject</div>
                      <div className="text-xl font-bold text-[#0F172A]">{report.locationName}</div>
                    </div>
                    <div>
                      <div className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2">Confidence Level</div>
                      <div className="text-xl font-bold text-slate-400">98.4% System Integrity</div>
                    </div>
                  </div>
               </div>

               {/* SECTION 02: AREA CHARACTER ANALYSIS */}
               <div className="p-16 md:p-20 border-b border-slate-100">
                  <div className="mb-24">
                    <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em] mb-8">Section 02 — Area Character Analysis</h3>
                    <p className="text-2xl font-bold text-[#0F172A] leading-[1.5] mb-12 max-w-2xl">
                      {report.knownFor}
                    </p>
                    <div className="grid grid-cols-2 gap-10">
                       <div className="border border-slate-100 p-10 bg-slate-50/30">
                          <h4 className="text-xs font-bold text-indigo-600 uppercase tracking-widest mb-6 border-b border-slate-100 pb-4">Core Strengths</h4>
                          <ul className="space-y-5">
                             {report.strengths.map((s, i) => (
                               <li key={i} className="flex items-start gap-4 text-sm font-medium text-slate-600 leading-relaxed">
                                  <div className="mt-1.5 w-1.5 h-1.5 bg-indigo-600 shrink-0"></div>
                                  <span>{s}</span>
                               </li>
                             ))}
                          </ul>
                       ...
                       <div className="border border-slate-100 p-10 bg-slate-50/30">
                          <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6 border-b border-slate-100 pb-4">Risk Factors</h4>
                          <ul className="space-y-5">
               ...
               <div className="p-16 md:p-20 border-b border-slate-100 bg-[#F8FAFC]/50">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                    <div>
                      <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-8">Section 03 — Living Experience Audit</h3>
                      <p className="text-2xl font-bold text-[#0F172A] leading-[1.4] mb-8">
                        Analytical assessment of daily operational stability and lifestyle metrics.
                      </p>
                      <div className="text-base font-medium text-slate-600 leading-[1.7] mb-12 max-w-lg">
                        {report.dailyLife}
                      </div>
                      <div className="flex gap-4">
                         <div className="w-1.5 h-1.5 bg-indigo-600 mt-2"></div>
                         <span className="text-[10px] font-bold text-[#0F172A] uppercase tracking-widest">Subject Asset Classification: Preferred Residential</span>
                      </div>
                    </div>
                    <div className="border border-slate-200 p-12 bg-white">
                       <h4 className="text-[10px] font-bold text-slate-400 uppercase mb-12 border-b border-slate-100 pb-4">Analysis Integrity Matrix</h4>
                       <div className="space-y-10">
                          {Object.entries(report.scores).map(([key, val]) => (
                            <div key={key}>
                               <div className="flex justify-between items-end mb-4">
                                  <span className="text-[9px] font-bold text-[#0F172A] uppercase tracking-[0.2em]">{key} Matrix</span>
                                  <span className="text-xl font-bold text-[#0F172A]">{val}<span className="text-[10px] text-slate-400 ml-1">/ 10</span></span>
                               </div>
                               <div className="h-[2px] bg-slate-100">
                                  <div className="h-full bg-indigo-600" style={{ width: `${val * 10}%` }}></div>
                               </div>
                            </div>
                          ))}
                       </div>
               ...
               <div className="p-16 md:p-20 border-b border-slate-100">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
                     <div className="md:col-span-2">
                        <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-8">Section 04 — Capital & Growth Projection</h3>
                        <p className="text-3xl font-bold text-[#0F172A] mb-8 tracking-tight uppercase">Development Impact Audit</p>
                        <div className="text-lg font-medium text-slate-500 leading-[1.6]">
                          {report.futureOutlook}
                        </div>
                     </div>
                     <div className="border border-slate-100 p-8 flex flex-col justify-between bg-slate-50/50">
                        <div className="text-[9px] font-bold text-slate-400 uppercase mb-2">Primary Investment Strategy</div>
                        <div className="text-xl font-bold uppercase text-[#0F172A]">{report.investmentPerspective.strategy}</div>
                        <div className="mt-8 pt-8 border-t border-slate-200">
                           <div className="text-[9px] font-bold text-slate-400 uppercase mb-1">Market Risk Profile</div>
                           <div className="text-sm font-bold text-indigo-600 uppercase">{report.investmentPerspective.risk} Exposure</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="bg-[#0F172A] text-white p-20 text-center relative overflow-hidden">
                    <span className="text-[10px] font-bold uppercase tracking-[0.6em] mb-6 block text-slate-500">Official Decision Protocol</span>
                    ...
                    <div className="max-w-2xl mx-auto border-t border-white/10 pt-10 mb-12">
                       <p className="text-xl font-medium tracking-tight text-slate-300 leading-relaxed">“{report.finalVerdict.insight}”</p>
                    </div>
                    <div className="inline-block px-10 py-3 border border-slate-700 text-[9px] font-bold uppercase tracking-[0.4em] text-indigo-400">
